...
class PriceCosting(Document):
	...
	def calculate_charges(self):
		...
		for i in self.items:
			...
			i.landed_cost = flt(i.source_rate + i.insurance + i.frieght + i.gst + i.custom_duty + i.excise_duty + i.service_charges + i.clearing_and_forwarding_charges + i.bank_charges + i.transportation_charges + i.labour_charges, 2)
