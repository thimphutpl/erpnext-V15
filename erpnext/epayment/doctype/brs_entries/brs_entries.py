...
class BRSEntries(Document):
	...
	if TYPE_CHECKING:
		...
		amount: DF.Currency
		cheque_no: DF.Data
		clearing_date: DF.Date
		clearing_time: DF.Data | None
		company: DF.Link | None
		jrnl_no: DF.Data | None
		narration: DF.Data | None
		reconciled: DF.Check
		reconciled_doc: DF.DynamicLink | None
		reconciled_doctype: DF.Link | None
		ref_no: DF.Data | None
