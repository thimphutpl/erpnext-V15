...
frappe.ui.form.on("Budget Release Account", {	
	monthly_release: function(frm, cdt, cdn) {
        let row = locals[cdt][cdn];
        if(row.monthly_release && row.approved_budget) {
            row.released_budget = row.approved_budget / 12;
        } else {
