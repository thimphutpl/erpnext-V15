...
class InsuranceandRegistration(Document):
    ...
    def post_to_account(self, args):
        ...
        # debit_account = frappe.db.get_single_value("Company", "registration_account")
        debit_account = frappe.db.get_value("Company", self.company, "registration_account")
        if not debit_account:
