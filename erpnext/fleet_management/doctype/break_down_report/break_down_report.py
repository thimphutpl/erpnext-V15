...
class BreakDownReport(Document):
	...
	if TYPE_CHECKING:
		...
		job_outsourced_footer: DF.TextEditor | None
		job_outsourced_header: DF.TextEditor | None
		outsourced: DF.Check
		owned_by: DF.Literal["", "Own Branch", "Own Company", "Others"]
		...
		text_editor_dxjm: DF.TextEditor | None
		time: DF.Time
