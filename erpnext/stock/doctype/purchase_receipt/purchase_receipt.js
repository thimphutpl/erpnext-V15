	...
	refresh() {
		...
		if (!this.frm.doc.is_return && this.frm.doc.status != "Closed") {
			...
			if (this.frm.doc.docstatus == 1 && this.frm.doc.status != "Closed") {
				...
				//disable by Kinzang. N, becuase stock entry is not doing from PR.
				// cur_frm.add_custom_button(
				// 	__("Make Stock Entry"),
				...
				//disable by Kinzang. N, becuase asset issue entry is not doing from PR. this make user confused
