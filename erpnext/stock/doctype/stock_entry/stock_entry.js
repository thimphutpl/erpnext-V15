...
// 	let show = frm.doc.stock_entry_type === "Material Issue" || frm.doc.stock_entry_type === "Material Transfer";

// 	frm.fields_dict['items'].grid.toggle_display('employee', show);
// 	frm.fields_dict['items'].grid.toggle_display('employee_name', show);
