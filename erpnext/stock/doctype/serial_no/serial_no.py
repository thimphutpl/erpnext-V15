...
class SerialNo(StockController):
	...
	if TYPE_CHECKING:
		...
		delivery_document_no: DF.DynamicLink | None
	...
	def set_sales_details(self, delivery_sle):
		...
		if delivery_sle:
			...
			self.outgoing_rate = delivery_sle.incoming_rate
