...
class JournalEntryAccount(Document):
	...
	if TYPE_CHECKING:
		...
		reference_type: DF.Literal["", "Sales Invoice", "Purchase Invoice", "Journal Entry", "Sales Order", "Purchase Order", "Expense Claim", "Asset", "Loan", "Payroll Entry", "Employee Advance", "Exchange Rate Revaluation", "Invoice Discounting", "Fees", "Full and Final Statement", "Payment Entry", "Travel Advance", "Travel Claim", "Muster Roll Payment Entry", "Leave Encashment", "Visitor Pass Registry", "Insurance and Registration", "POL Advance", "Fee Closing Entry", "Cash Deposit Entry", "Asset Value Adjustment", "Leave Travel Concession"]
