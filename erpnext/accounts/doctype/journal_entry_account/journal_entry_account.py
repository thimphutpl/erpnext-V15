...
class JournalEntryAccount(Document):
	...
	if TYPE_CHECKING:
		...
		party_type: DF.Literal["", "Customer", "Supplier", "Employee", "Equipment"]
		project: DF.Link | None
		rate: DF.Float
		reference_detail_no: DF.Data | None
		reference_due_date: DF.Date | None
		reference_name: DF.DynamicLink | None
		reference_type: DF.Literal["", "Bonus", "PBVA", "Sales Invoice", "SWS Application", "Purchase Invoice", "Journal Entry", "Sales Order", "Purchase Order", "Expense Claim", "Asset", "Loan", "Payroll Entry", "Employee Advance", "Exchange Rate Revaluation", "Invoice Discounting", "Fees", "Full and Final Statement", "Payment Entry", "Abstract Bill", "Imprest Advance", "Imprest Recoup", "POL Advance", "Process MR Payment", "Travel Claim", "Travel Authorization", "Fund Requisition", "Leave Encashment", "Bulk Leave Encashment", "Leave Travel Concession", "Equipment Hiring Form", "Job Cards", "Employee Benefits", "Hire Charge Invoice", "Hire Invoice", "Fabrication And Bailey Bridge", "Transporter Invoice", "Travel Advance", "Asset Value Adjustment", "Royalty Payment", "Overtime Application", "Equipment", "Other Contribution"]
