...
erpnext.accounts.PurchaseInvoice = class PurchaseInvoice extends erpnext.buying.BuyingController {
	...
	refresh(doc) {
		...
		if (!doc.is_return && doc.docstatus == 1 && doc.outstanding_amount != 0 && doc.company!="Office of the Gyalpoi Zimpon") {
			if (doc.on_hold) {
		...
		if (doc.outstanding_amount > 0 && !cint(doc.is_return) && !doc.on_hold && doc.company!="Office of the Gyalpoi Zimpon") {
