...
class BankPayment(Document):
    ...
    if TYPE_CHECKING:
        from erpnext.accounts.doctype.bank_payment_debit_note.bank_payment_debit_note import BankPaymentDebitNote
        from erpnext.accounts.doctype.bank_payment_item.bank_payment_item import BankPaymentItem
        from erpnext.accounts.doctype.bank_payment_summary.bank_payment_summary import BankPaymentSummary
        from erpnext.accounts.doctype.bank_payment_upload.bank_payment_upload import BankPaymentUpload
