...
// 	if(frm.doc.docstatus == 1 && frm.doc.payment_type == "Pay" && frm.doc.party_type == 'Supplier' && frm.doc.mode_of_payment != "LC(Letter of Credit)" /*&& !frm.doc.cheque_no*/){
...
var create_custom_buttons = function(frm){
	...
	if(frm.doc.docstatus == 1 && frm.doc.payment_type == "Pay" && frm.doc.party_type == 'Supplier' && frm.doc.mode_of_payment != "LC(Letter of Credit)" && frm.doc.mode_of_payment != "Cash" && frm.doc.mode_of_payment != "Cheque" /*&& !frm.doc.cheque_no*/){
		if(!frm.doc.bank_payment || status.includes(frm.doc.payment_status) ){
			frm.page.set_primary_action(__('Process Payment'), () => {
				frappe.model.open_mapped_doc({
					method: "erpnext.accounts.doctype.payment_entry.payment_entry.make_bank_payment",
