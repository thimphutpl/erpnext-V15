...
def get_gl_entries(filters, accounting_dimensions):
	...
	gl_entries = frappe.db.sql(
		...
		select
			...
			gle.against, gle.is_opening, jea.broad_head, jea.budget_activity, jea.budget_sub_activity, gle.creation {select_fields}
...
def get_conditions(filters):
	...
	if filters.get("budget_activity"):
		conditions.append("jea.budget_activity = %(budget_activity)s")

	if filters.get("budget_sub_activity"):
		conditions.append("jea.budget_sub_activity = %(budget_sub_activity)s")		
