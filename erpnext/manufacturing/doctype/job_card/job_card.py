...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		add_items: DF.Table[JobCardItem]
	...
	def before_submit(self):
		wo = frappe.db.get_value("Work Order", self.work_order, "status")
		if wo != "In Process":
			frappe.throw("Work Order not started. Please start work order {}".format(
